...
// in simulator we redefine to format for UIDining Developer console
...
{\
	NSString * exceptionName = [@"org.uidining." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.uidining";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIUIDiningNativeItemNone = -1, 
	UIUIDiningNativeItemSpinner = -2,
	UIUIDiningNativeItemProgressBar = -3,
	
	UIUIDiningNativeItemSlider = -4,
	UIUIDiningNativeItemSwitch = -5,
	UIUIDiningNativeItemMultiButton = -6,
	UIUIDiningNativeItemSegmented = -7,
	
	UIUIDiningNativeItemTextView = -8,
	UIUIDiningNativeItemTextField = -9,
	UIUIDiningNativeItemSearchBar = -10,
	
	UIUIDiningNativeItemPicker = -11,
	UIUIDiningNativeItemDatePicker = -12,
	
	UIUIDiningNativeItemInfoLight = -13,
	UIUIDiningNativeItemInfoDark = -14,
	
	UIUIDiningNativeItemDisclosure = -15,
	
	UIUIDiningNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all UIDining instances of
