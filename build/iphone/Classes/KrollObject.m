...
//@interface UIDiningObject : NSObject
//@end

@interface UIDiningObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[UIDiningObject class]])
		{
			for (NSString *key in [[(UIDiningObject*)o modules] allKeys])
			{
